...
module.exports = {
  title: "StableVideo",
  description: "[ICCV 2023] StableVideo: Text-driven Consistency-aware Diffusion Video Editing https://rese1f.github.io/StableVideo/",
  icon: "icon.jpeg",
  menu: async (kernel) => {
    let installed = await exists(path.resolve(__dirname, "StableVideo", "env"))
    if (installed) {
